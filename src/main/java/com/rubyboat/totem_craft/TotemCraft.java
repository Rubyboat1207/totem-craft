...
public class TotemCraft implements ModInitializer {
	...
	public static RegistryEntry<StatusEffect> verdance = Registry.registerReference(Registries.STATUS_EFFECT, new Identifier(MOD_ID, "verdance"),new CustomStatusEffect(StatusEffectCategory.BENEFICIAL, 0x32CD32));
	...
	public void onInitialize() {
		...
		//Totem items
		axolotlTotem = new TotemItem(new Item.Settings(), new Identifier(MOD_ID, "axolotl_totem"), axolotlEffects, 6, new AndEffect(new RemoveArmorEffect(), new RemoveArrowsEffect()));
		...
		codTotem = new TotemItem(new Item.Settings(), new Identifier(MOD_ID, "cod_totem"), fishEffects, 2, new GiveItemEffect(new ItemStack(Items.COOKED_COD, 1)));
		...
		foxTotem = new TotemItem(new Item.Settings(), new Identifier(MOD_ID, "fox_totem"), foxEffects, 8, new GiveItemEffect(new ItemStack(Items.SWEET_BERRIES, 16)));
		...
		pandaTotem = new TotemItem(new Item.Settings(), new Identifier(MOD_ID, "panda_totem"), pandaEffects, 10, new DistributePillarsEffect(Blocks.BAMBOO.getDefaultState(), 10, 50, 0, 15, BlockTags.BAMBOO_PLANTABLE_ON));
		...
		villagerTotem = new TotemItem(new Item.Settings(), new Identifier(MOD_ID, "villager_totem"), villagerEffects, 16, new GiveItemEffect(new ItemStack(Items.EMERALD_BLOCK, 2)));
		wanderingTraderTotem = new TotemItem(new Item.Settings(), new Identifier(MOD_ID, "wandering_trader_totem"), villagerEffects, 8, new AndEffect(new GiveItemEffect(new ItemStack(Items.EMERALD_BLOCK, 2)), new RandomTeleport(16)));
		...
		zombieVillagerTotem = new TotemItem(new Item.Settings(), new Identifier(MOD_ID, "zombie_villager_totem"), zombieEffects, 6, new GiveItemEffect(new ItemStack(Items.EMERALD_BLOCK, 2)));
		...
		allayTotem = new TotemItem(new Item.Settings(), new Identifier(MOD_ID, "allay_totem"), allayEffects, 10, new GiveItemEffect(new ItemStack(Items.COOKIE, 3)));
		...
		armadilloTotem = new TotemItem(new Item.Settings(), new Identifier(MOD_ID, "armadillo_totem"), armadilloEffects, 20, null);
	}
